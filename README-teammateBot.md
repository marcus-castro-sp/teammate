...
3. Give the bot a handle (ex: `teammateBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://teammatebot.azurewebsites.net/api/messages`
